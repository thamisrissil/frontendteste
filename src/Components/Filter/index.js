      ...
      <section>
        ...
        <section className="mb-4">
          ...
          <a href="#!">
            <ul className="rating">
              <li>
                <i className="fas fa-star fa-sm text-primary"></i><i class="fas fa-star fa-sm text-primary"></i><i class="fas fa-star fa-sm text-primary"></i><i class="fas fa-star fa-sm text-primary"></i><i class="far fa-star fa-sm text-primary"></i> <p>& Up</p>
              </li>
            </ul>
          </a>
          ...
          <a href="#!">
            <ul className="rating">
              <li>
                <i className="fas fa-star fa-sm text-primary"></i><i class="fas fa-star fa-sm text-primary"></i><i class="fas fa-star fa-sm text-primary"></i><i class="far fa-star fa-sm text-primary"></i><i class="far fa-star fa-sm text-primary"></i>
              </li>
              <li>
          ...
          <a href="#!">
            <ul className="rating">
              <li>
                <i className="fas fa-star fa-sm text-primary"></i><i class="fas fa-star fa-sm text-primary"></i><i class="far fa-star fa-sm text-primary"></i><i class="far fa-star fa-sm text-primary"></i><i class="far fa-star fa-sm text-primary"></i>
              </li>
              <li>
                <p className="small text-uppercase card-link-secondary px-2">& Up</p>
              </li>
